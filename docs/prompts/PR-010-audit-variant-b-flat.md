# PR-010 — Audit Variant B (flat)

Flat Codex-compatible version of PR-003 Variant B: the two-pass
checklist audit approach for the PH-000 requirements inventory.

**How to run:**

```
prompt-runner run docs/prompts/PR-010-audit-variant-b-flat.md \
...
## Prompt 2: Audit the requirements inventory (Variant B)
