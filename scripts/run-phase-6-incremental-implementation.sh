...
prompt_file="${PROMPT_FILE:-.methodology/docs/prompts/PR-029-ph006-incremental-implementation.md}"
project_dir="${PROJECT_DIR:-tests/fixtures/ph006-hello-world-workspace}"
