...
_PHASE_2_ARCHITECTURE = PhaseConfig(
    ...
    judge_guidance=(
        ...
        "5. Simulation target drift: flag simulation targets that are docs,\n"
        "   verification, test suites, or other non-provider components.\n"
        "6. Missing rationale: the rationale field must explain the\n"
...
_PHASE_3 = PhaseConfig(
    ...
    judge_guidance=(
        ...
        "6. Missing processing examples: every specified processing function\n"
        "   needs at least one concrete input/output example.\n"
        "7. Missing UI mockups: every specified UI surface needs an HTML mockup."
    ),
    artifact_format="yaml",
    artifact_schema_description=(
        "components:\n"
...
_PHASE_6 = PhaseConfig(
    ...
    generation_instructions=(
        ...
        "README content inside the current worktree. When simulation artifacts\n"
    ...
    judge_guidance=(
        ...
        "   contracts, simulation artifact lists, usage instructions, or\n"
        "   simulation-backed behaviors from prior phases.\n"
