...
prompt_file=".methodology/docs/prompts/PR-027-ph004-interface-contracts.md"
project_dir="tests/fixtures/ph004-hello-world-workspace"
run_dir="work/ph004-interface-contracts-run"
