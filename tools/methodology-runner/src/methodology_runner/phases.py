...
_PHASE_5 = PhaseConfig(
    ...
    judge_guidance=(
        ...
        "   contract alone (e.g., internal database IDs, exact runtime\n"
        "   timestamp literals). For contractually dynamic values such as\n"
        "   current date/time, accept contract-format exemplars plus\n"
        "   pattern assertions, but reject fake placeholder text treated as\n"
        "   successful observed output.\n"
