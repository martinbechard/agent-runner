...
prompt_file="${PROMPT_FILE:-.methodology/docs/prompts/PR-027-ph004-interface-contracts.md}"
project_dir="${PROJECT_DIR:-tests/fixtures/ph004-hello-world-workspace}"
