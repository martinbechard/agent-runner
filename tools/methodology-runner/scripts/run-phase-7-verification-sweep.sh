...
prompt_file="${PROMPT_FILE:-tools/methodology-runner/docs/prompts/PR-030-ph007-verification-sweep.md}"
project_dir="${PROJECT_DIR:-tools/methodology-runner/fixtures/ph007-hello-world-workspace}"
