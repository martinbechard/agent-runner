...
prompt_file=".methodology/docs/prompts/PR-030-ph007-verification-sweep.md"
project_dir="tests/fixtures/ph007-hello-world-workspace"
run_dir="work/ph007-verification-sweep-run"
