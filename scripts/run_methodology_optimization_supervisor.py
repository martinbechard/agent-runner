...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--workflow-root",
        default=None,
        help="Explicit workflow root. Defaults to <project>/.prompt-runner/workflows/methodology-opt/<timestamp>-<slug>/",
    )
    ...
    workflow_root = (
        ...
        else repo_root / ".prompt-runner" / "workflows" / "methodology-opt" / f"{timestamp}-{slug}"
    )
