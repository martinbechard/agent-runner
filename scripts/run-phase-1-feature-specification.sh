...
prompt_file="${PROMPT_FILE:-.methodology/docs/prompts/PR-023-ph001-feature-specification.md}"
project_dir="${PROJECT_DIR:-tests/fixtures/ph001-hello-world-workspace}"
