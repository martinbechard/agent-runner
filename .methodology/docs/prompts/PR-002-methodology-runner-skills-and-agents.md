...
`.methodology/docs/M-002-phase-definitions.md`.
...
A directory tree at `.methodology/skills/` under the repo
root:
...
`<cwd>/.methodology/skills/**/SKILL.md` as a discovery source. This
means as long as you run `methodology-runner run ...` from the repo
root (where `.methodology/skills/` exists),
...
Verify by listing the structure:
    ...
    ls .methodology/skills/traceability-discipline/SKILL.md
    ls .methodology/skills/README.md

## Commit

    git add .methodology/skills/
    git commit -m "feat(skills): scaffold methodology skills"
...
## Target file
    ...
    .methodology/skills/traceability-discipline/SKILL.md
...
# (run from repo root so repo-methodology discovery finds the skills)
...
## Commit
    ...
    git add .methodology/skills/traceability-discipline/
...
## Target file
    ...
    .methodology/skills/requirements-extraction/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/requirements-extraction/
...
## Target file
    ...
    .methodology/skills/requirements-quality-review/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/requirements-quality-review/
...
## Target file
    ...
    .methodology/skills/feature-specification/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/feature-specification/
...
## Target file
    ...
    .methodology/skills/feature-quality-review/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/feature-quality-review/
...
## Target file
    ...
    .methodology/skills/architecture-decomposition/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/architecture-decomposition/
...
## Target file
    ...
    .methodology/skills/tech-stack-catalog/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/tech-stack-catalog/
...
## Target file
    ...
    .methodology/skills/architecture-review/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/architecture-review/
...
## Target file
    ...
    .methodology/skills/solution-design-patterns/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/solution-design-patterns/
...
## Target file
    ...
    .methodology/skills/solution-design-review/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/solution-design-review/
...
## Target file
    ...
    .methodology/skills/contract-first-design/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/contract-first-design/
...
## Target file
    ...
    .methodology/skills/contract-review/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/contract-review/
...
## Target file
    ...
    .methodology/skills/simulation-framework/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/simulation-framework/
...
## Target file
    ...
    .methodology/skills/simulation-review/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/simulation-review/
...
## Target file
    ...
    .methodology/skills/tdd/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/tdd/
...
## Target file
    ...
    .methodology/skills/code-review-discipline/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/code-review-discipline/
...
## Target file
    ...
    .methodology/skills/cross-component-verification/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/cross-component-verification/
...
## Target file
    ...
    .methodology/skills/verification-review/SKILL.md
...
## Commit
    ...
    git add .methodology/skills/verification-review/
...
3. Update `.methodology/skills/README.md` with:
...
5. Commit the README and release notes updates:
       ...
       git add .methodology/skills/README.md \
               docs/superpowers/specs/2026-04-09-skill-pack-and-interactive-harness-notes.md
