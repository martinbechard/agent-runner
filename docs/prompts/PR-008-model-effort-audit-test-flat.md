# PR-008 — Model & effort level comparison for audit (flat)

Cross-model and cross-effort test of the two-pass checklist audit
without using prompt-runner `[VARIANTS]`. This is the Codex-compatible
flat version of PR-004: each audit case is a normal prompt so the run
does not rely on fork-session inheritance.

**How to run:**

```
prompt-runner run docs/prompts/PR-008-model-effort-audit-test-flat.md \
...
## Prompt 2: Opus default (baseline)
...
## Prompt 3: Sonnet default [MODEL:claude-sonnet-4-6]
...
## Prompt 4: Haiku default [MODEL:claude-haiku-4-5-20251001]
...
## Prompt 5: Opus medium effort [EFFORT:medium]
...
## Prompt 6: Opus low effort [EFFORT:low]
...
## Prompt 7: Sonnet medium effort [MODEL:claude-sonnet-4-6] [EFFORT:medium]
