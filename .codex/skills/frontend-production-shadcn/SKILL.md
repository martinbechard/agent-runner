...
For a scored or durable UI review, complete
`references/evidence-review-checklist.md`. Mark technology-specific rows `N/A`
when the target does not use React, Tailwind CSS, or shadcn/ui, and explain the
applicability decision rather than treating another stack as shadcn.
