...
_PHASE_0 = PhaseConfig(
    ...
    generation_instructions=(
        ...
        "items.\n"
        "\n"
        "Treat bullets, numbered entries, table rows, and comma-separated\n"
        "fields under requirement-bearing lead-ins such as must support,\n"
        "must include, must show, must provide, must expose, must cover,\n"
        "or must handle as independently satisfiable requirements when each\n"
        "entry can be quoted from a contiguous source span.\n"
        "\n"
