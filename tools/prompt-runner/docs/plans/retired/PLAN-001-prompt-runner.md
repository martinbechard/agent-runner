...
**Parent artifacts:**
- Design: *.prompt-runner/docs/design/components/CD-001-prompt-runner.md*
- Design ACs: §14 of the design doc
- Implementation ACs: *.prompt-runner/docs/testing/AC-001-prompt-runner.md*
...
.prompt-runner/README.md                    # new — input-format guide for AI/human file authors
...
Design reference: §8 (Verdict parser) and §8 test list in *.prompt-runner/docs/design/components/CD-001-prompt-runner.md*.
...
Design reference: §3 (input contract), §6.1 (data model), §6.2 (state machine algorithm), §6.3 (error catalogue), §6.4 (test list) in *.prompt-runner/docs/design/components/CD-001-prompt-runner.md*.
...
See .prompt-runner/docs/design/components/CD-001-prompt-runner.md sections 3, 6.1, 6.2, 6.3.
"""
from __future__ import annotations
...
Design reference: §5 (CLI shape) and §12 step 3 in *.prompt-runner/docs/design/components/CD-001-prompt-runner.md*.
...
**Files:**
- Create: *.prompt-runner/README.md*
- Create: *tests/cli/prompt_runner/fixtures/readme-example.md*
- Create: *tests/cli/prompt_runner/test_readme.py*

Design reference: §13 in *.prompt-runner/docs/design/components/CD-001-prompt-runner.md*.
...
```bash
git add .prompt-runner/README.md tests/cli/prompt_runner/fixtures/readme-example.md tests/cli/prompt_runner/test_readme.py
...
Design reference: §7 (Claude client) in *.prompt-runner/docs/design/components/CD-001-prompt-runner.md*. The real streaming implementation is deferred to Task 7; this task builds only the protocol, dataclasses, and fake/dry-run doubles that the runner tests in Task 6 will depend on.
...
Design reference: §9 (runner engine) and §9.4 (prompt builders), §9.5 (test list) in *.prompt-runner/docs/design/components/CD-001-prompt-runner.md*.
...
Design reference: §7.1 (Real implementation, streaming and log capture), §7.4 in *.prompt-runner/docs/design/components/CD-001-prompt-runner.md*.
...
Design reference: §5 (CLI shape), §11.3 (halt semantics), §11.4 (success banner) in *.prompt-runner/docs/design/components/CD-001-prompt-runner.md*.
...
Design reference: AC-24 in *.prompt-runner/docs/testing/AC-001-prompt-runner.md*.
...
Expected: all tests PASS, indicating every AC from *.prompt-runner/docs/testing/AC-001-prompt-runner.md* that is automated (everything except AC-24, which is this manual smoke test) is green.
