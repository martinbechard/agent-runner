...
prompt_file="${PROMPT_FILE:-tools/methodology-runner/docs/prompts/PR-024-ph002-architecture.md}"
project_dir="${PROJECT_DIR:-tools/methodology-runner/fixtures/ph002-hello-world-workspace}"
